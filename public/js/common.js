...
logoutButton.addEventListener('click', async function() {
    try {
        const response = await fetch('http://43.201.148.13:8000/api/user/logout', {
            method: 'POST',
            headers: {
...
async function load() {
    try {
        ...
        document.getElementById('profile_image').src = data.profileImage ? `http://43.201.148.13:8000${data.profileImage}` : '/images/profile_img.png';
    } catch (error) {
